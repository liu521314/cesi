package com.fh.shop.util.download;
...
public class FileUtil {
	...
	public static void downloadWord(HttpServletResponse response, HttpServletRequest request, String outFile) throws IOException {
		byte b[] = outFile.getBytes("utf-8");  //这里是必须要设置编码的，不然导出中文就会乱码。
		...
		response.addHeader("Content-Disposition", "attachment;filename=" +
				new String( (UUID.randomUUID().toString() + ".docx").getBytes(),
						"iso-8859-1"));
	...
	public static void pdfDownloadFile(HttpServletResponse response, String htmlContent, String font) {
		OutputStream os = null;
	 ...
	 */
	public static void excelDownload(Workbook workBook, HttpServletResponse response) {
	...
	/*Pdf导出*/
	public static StringWriter getStringWriter(Map map, String templates, String pdfHtml) throws IOException, TemplateException {
		Configuration configuration = new Configuration();
		configuration.setDefaultEncoding("UTF-8");
		//freemarker的模板目录
		configuration.setClassForTemplateLoading(FileUtil.class, templates);
		// 获取模板,并设置编码方式
		Template template = configuration.getTemplate(pdfHtml);
	...
	/*Word导出*/
	public static StringWriter getWordStringWriter(Map map, String templates, String wordHtml) throws IOException, TemplateException {
		Configuration configuration = new Configuration();
		configuration.setDefaultEncoding("utf-8");
		configuration.setClassForTemplateLoading(FileUtil.class,templates);
		Template template = configuration.getTemplate(wordHtml, "utf-8");
		StringWriter stringWriter = new StringWriter();
		template.process(map,stringWriter);
		return stringWriter;
	}
